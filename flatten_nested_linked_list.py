...
# (i.e., it is a nested list). Your task is to flatten this nested list—that is, to combine all nested lists into a single (sorted) linked list.
...
def merge(list1, list2):
    ...
    while first_node is not None or second_node in not None:
